...
mexico_appx_captions <- list(
  moderately_marginalized = "List of municipalities included in the moderately marginalised category, along with relevant indicators.",
  severely_marginalized = "List of municipalities included in the severely marginalised category, along with relevant indicators."
)
```
...
As described in Section 2.2.1, priors for VR bias were set by municipality based on an index for estimated social marginalization. Lists of municipalities in the moderately marginalised grouping (N=437/2,441) and the severely marginalised grouping (N=152/2,441) are included below in Table \@ref(tab:appx-moderately-marginalized) and Table \@ref(tab:appx-severely-marginalized), respectively. Values for the four indicators used to define the marginalization groupings are listed for each municipality.
...
knitr::opts_chunk$set(fig.pos = "!h", out.extra = "", fig.align = 'center', echo=FALSE)

# Set caption text
india_appx_captions <- list(
  cov_access = "Map of gridded covariate showing travel time by motorised vehicle to the nearest settlement of 50,000 or greater in 2000 and 2017. Source: Malaria Atlas Project",
...
```{r india-cov-dpt3, out.width="100%", fig.cap = india_appx_captions$cov_dpt3}
