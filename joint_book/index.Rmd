...
Complete and accurate health information systems are necessary inputs for effective health policy. Full registration of births, deaths, and notifiable infectious diseases across a country ensures that all citizens receive the same legal and health protections. Although many countries maintain civil registration and infectious disease surveillance systems, variation in data completeness often impedes analysis of aggregated health records at the spatial level where policymaking occurs, discouraging greater reliance and investment in these systems.
...
The Mexican civil registration and vital statistics (CRVS) system serves as an example of a health information system that is nearly complete at the national level, but may still face data completeness challenges in particular localities. I develop a model that synthesizes CRVS and supplementary spatial data sources to estimate both neonatal mortality and and CRVS completeness by municipality across Mexico. This spatial modelling strategy can be applied to a wide array of health outcomes, including notifiable infectious diseases such as tuberculosis (TB). I demonstrate how an analogous model can combine data from a TB prevalence survey and a time series of TB case notifications to estimate TB prevalence as well as case notification completeness across Uganda.

Complete health information systems offer a wide array of benefits to national well-being that extend beyond their informational content. I take a holistic approach to analyze the capacity of India's three health surveillance systems to enable goals set in the Indian National Health Plan.

The COVID-19 pandemic has highlighted gaps in health surveillance capacity worldwide, including in high-income countries where registration was previously considered complete. In Italy, I develop a small-area excess mortality model to estimate the number of misdiagnosed COVID-19 deaths during the first six months of the pandemic. This analysis reveals important information about the mortality dynamics of the pandemic by province, week, age group, and sex.

The results and conclusions of these case studies are discussed with recommendations for how these findings influence our understanding of health information systems and implications for greater integration between health surveillance data and policy.
...
I would also like to thank the many colleagues who have generously shared their time and knowledge with me. I have been enormously lucky to work with and learn from members of the Malaria Atlas Project, the Oxford AMR group, and the Local Burden of Disease team over the past three years. A special thanks to Michael Chipeta, who went above and beyond to help me grow as a spatial statistician and researcher. I am also enormously grateful to have worked with Jen Ross, whose deep knowledge of and passion for TB research continues to inspire me.

I am hugely appreciative of my office mates and friends who have been by my side, first in person and then in spirit (and Slack), throughout my graduate studies. To my VR and U5M teams, thanks for being the salt of the earth; to my Torch Club friends, thanks for adding the spice to life.

None of this would have been possible without the love and support of my family. Mom and dad, thanks for always believing in my adventures. Lizzie, thanks for always keeping it real.

Finally, I dedicate this thesis to my fiancee Ellen. Four years ago, at a pivotal moment, she asked me what I wanted to wake up to do every day for the rest of my life---this is the start of my answer. Thank you for everything since then and for everything to come.
...
\begin{acronym}
  ...
  \acro{GLM}{Generalized linear modelling}
  ...
  \acro{SCORE}{Survey, Count, Optimize, Review, Enable}
  \acro{SMR}{Standardized mortality ratio}
