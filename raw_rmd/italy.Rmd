...
author:
  ...
  - name: "Michele Nguyen"
    institute: [nanyang]
  - name: "Michael Chipeta"
    institute: [bdi]
  - name: "Catrin Moore"
    institute: [bdi]
    correspondence: true
    email: catrin.moore@ndm.ox.ac.uk
institute:
  - bdi: "Big Data Institute, Li Ka Shing Centre for Information Discovery, University of Oxford, Oxford, UK"
  - telethon: "Telethon Kids Institute, Perth Children Hospital, Perth, Western Australia, Australia"
  - nanyang: "Asian School of the Environment, Nanyang Technological University, Singapore 639798, Singapore"
date: "`r Sys.Date()`"
...
```{r excess-neighbors, out.width="100%", fig.cap = captions$excess_neighbors}
