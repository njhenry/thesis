...
Here, $Q_s$ is a logit-linear surface indexed by spatial unit (s). The estimated value for $Q_s$ is centered around an intercept $\alpha$ and varies according to covariate fixed effects $\overrightarrow{\beta}X_s$, with known $X_s$ denoting predictive covariates that vary by municipality. Remaining variation not captured by covariates is fit by a structured random effects $Z_s$, which corresponds to the BYM2 spatial model formulation described by Riebler and colleagues.[@Riebler2016] This model formulation has both spatial and I.I.D. components, with model parameters identifying the overall variance of this term as well as the proportion of excess variation associated with spatial autocorrelation. Spatial autocorrelation is fit between directly neighboring municipalities identified from the INEGI shapefile.[@INEGI2010b]
